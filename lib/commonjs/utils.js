...
exports.JSONP_EXTRACTOR_NAME = exports.GRADE_LEVEL_MAP = exports.CONTENT_TYPE_MAP_REVERSE = exports.CONTENT_TYPE_MAP = void 0;
...
const CONTENT_TYPE_MAP = exports.CONTENT_TYPE_MAP = new Map([[_types.ContentType.NOTIFICATION, 'KCGG'], [_types.ContentType.FILE, 'KCKJ'], [_types.ContentType.HOMEWORK, 'KCZY'], [_types.ContentType.DISCUSSION, 'KCTL'], [_types.ContentType.QUESTION, 'KCDY']
// omitted: 问卷(KCWJ) & 课表(KCKB) as they are not supported now
]);
const CONTENT_TYPE_MAP_REVERSE = exports.CONTENT_TYPE_MAP_REVERSE = new Map([[CONTENT_TYPE_MAP.get(_types.ContentType.NOTIFICATION), _types.ContentType.NOTIFICATION], [CONTENT_TYPE_MAP.get(_types.ContentType.FILE), _types.ContentType.FILE], [CONTENT_TYPE_MAP.get(_types.ContentType.HOMEWORK), _types.ContentType.HOMEWORK], [CONTENT_TYPE_MAP.get(_types.ContentType.DISCUSSION), _types.ContentType.DISCUSSION], [CONTENT_TYPE_MAP.get(_types.ContentType.QUESTION), _types.ContentType.QUESTION]]);
