...
import { ContentType, CourseType, FailReason, Language } from "./types.js";
import * as URLS from "./urls.js";
import { CONTENT_TYPE_MAP_REVERSE, GRADE_LEVEL_MAP, JSONP_EXTRACTOR_NAME, decodeHTML, extractJSONPResult, formatFileSize, parseSemesterType, trimAndDefine } from "./utils.js";
...
export class Learn2018Helper {
  ...
  async getCourseList(semesterID, courseType = CourseType.STUDENT) {
    const json = await (await this.#myFetchWithToken(URLS.LEARN_COURSE_LIST(semesterID, courseType, this.#lang))).json();
  ...
  async getFavorites(courseID, type) {
    ...
    return result.map(e => {
      ...
      return {
        ...
        courseId: e.wlkcid,
        pinned: e.sfzd === YES,
        pinnedTime: e.zdsj === null ? undefined : new Date(e.zdsj),
