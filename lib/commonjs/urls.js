...
const LEARN_FAVORITE_OR_COMMENT_LIST_FORM_DATA = courseID => {
  const form = new _nodeFetchNative.FormData();
...
exports.LEARN_FAVORITE_OR_COMMENT_LIST_FORM_DATA = LEARN_FAVORITE_OR_COMMENT_LIST_FORM_DATA;
