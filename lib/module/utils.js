...
import { ContentType, FailReason, HomeworkGradeLevel, SemesterType } from "./types.js";
...
export const CONTENT_TYPE_MAP = new Map([[ContentType.NOTIFICATION, 'KCGG'], [ContentType.FILE, 'KCKJ'], [ContentType.HOMEWORK, 'KCZY'], [ContentType.DISCUSSION, 'KCTL'], [ContentType.QUESTION, 'KCDY']
// omitted: 问卷(KCWJ) & 课表(KCKB) as they are not supported now
]);
export const CONTENT_TYPE_MAP_REVERSE = new Map([[CONTENT_TYPE_MAP.get(ContentType.NOTIFICATION), ContentType.NOTIFICATION], [CONTENT_TYPE_MAP.get(ContentType.FILE), ContentType.FILE], [CONTENT_TYPE_MAP.get(ContentType.HOMEWORK), ContentType.HOMEWORK], [CONTENT_TYPE_MAP.get(ContentType.DISCUSSION), ContentType.DISCUSSION], [CONTENT_TYPE_MAP.get(ContentType.QUESTION), ContentType.QUESTION]]);
